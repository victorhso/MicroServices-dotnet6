    ...
    public partial class SeedProductsDataTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                table: "TB_GS_PRODUTO",
                columns: new[] { "ID", "DS_CATEGORIA", "DS_DESCRICAO", "DS_URL_IMAGEM", "DS_NOME", "VL_PRECO" },
                values: new object[,]
                {
                    { 2L, "Animal", "Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.", "https://img.freepik.com/fotos-gratis/imagem-aproximada-em-tons-de-cinza-de-uma-aguia-careca-americana-em-um-fundo-escuro_181624-31795.jpg?size=626&ext=jpg", "Nome", 69.99m },
